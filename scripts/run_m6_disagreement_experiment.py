#!/usr/bin/env python3
"""Run the bound M6 disagreement experiment through the real M5 runtime."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--workspace",
        type=Path,
        default=Path("artifacts/m6-trust-statistical-disagreement-v1"),
    )
    parser.add_argument(
        "--trust-workspace",
        type=Path,
        default=Path("artifacts/m4-trust-m6-disagreement-v1"),
    )
    parser.add_argument(
        "--node-root",
        type=Path,
        default=Path("artifacts/m4-nodes-m6-disagreement-v1"),
    )
    parser.add_argument(
        "--admission-config",
        type=Path,
    ...
    parser.add_argument(
        "--experiment-config",
        type=Path,
        default=Path("configs/trust-statistical-disagreement.yaml"),
    )
